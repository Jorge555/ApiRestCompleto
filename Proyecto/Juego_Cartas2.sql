...
CREATE TABLE IF NOT EXISTS `Yugi`.`Partida` (
  ...
  `id_Partidacol` INT NOT NULL AUTO_INCREMENT,
  INDEX `fk_Partida_Arena1_idx` (`Arena_cod_are` ASC),
  PRIMARY KEY (`id_Partidacol`),
...
CREATE TABLE IF NOT EXISTS `Yugi`.`Copas` (
  ...
  `Jugador_cod_jug` INT(3) NOT NULL,
  `Partida_id_Partidacol` INT NOT NULL,
  PRIMARY KEY (`idCopas`),
  INDEX `fk_Copas_Jugador1_idx` (`Jugador_cod_jug` ASC),
  INDEX `fk_Copas_Partida1_idx` (`Partida_id_Partidacol` ASC),
  CONSTRAINT `fk_Copas_Jugador1`
    FOREIGN KEY (`Jugador_cod_jug`)
    REFERENCES `Yugi`.`Jugador` (`cod_jug`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Copas_Partida1`
    FOREIGN KEY (`Partida_id_Partidacol`)
    REFERENCES `Yugi`.`Partida` (`id_Partidacol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Yugi`.`Jugadores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Yugi`.`Jugadores` (
  `idJugadores` INT NOT NULL AUTO_INCREMENT,
  `Jugador_cod_jug` INT(3) NOT NULL,
  `Partida_id_Partidacol` INT NOT NULL,
  PRIMARY KEY (`idJugadores`),
  INDEX `fk_Jugadores_Jugador1_idx` (`Jugador_cod_jug` ASC),
  INDEX `fk_Jugadores_Partida1_idx` (`Partida_id_Partidacol` ASC),
  CONSTRAINT `fk_Jugadores_Jugador1`
    FOREIGN KEY (`Jugador_cod_jug`)
    REFERENCES `Yugi`.`Jugador` (`cod_jug`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
